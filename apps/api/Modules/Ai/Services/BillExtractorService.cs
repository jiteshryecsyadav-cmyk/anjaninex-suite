...
public class BillExtractorService : IBillExtractorService
{
    ...
    private static readonly Dictionary<string, (string Provider, string Model)> ModelAllowlist = new()
    {
        ...
        // Anjaninex OCR Technology — engine Gemini Flash vision (dense photo bills bhi accurate).
...
";
    ...
    // =====================================================================
    // "OCR Technology" engine = Gemini Flash VISION (asli image seedha padhta — dense photo
    // bills par bhi saare items + sahi total). Branding "OCR Technology" rahti hai.
