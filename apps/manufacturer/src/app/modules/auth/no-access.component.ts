  ...
  template: `
    <div class="min-h-screen grid place-items-center p-4">
      <div class="bg-white rounded-2xl max-w-sm w-full p-6 text-center">
        ...
        <div class="font-extrabold text-anjaninex-navy text-lg mb-1">Ye screen aapke liye nahi hai</div>
        <p class="text-sm text-slate-600 mb-3">
          Malik se kahiye ki aapke role me ye ijazat chalu kar dein.
        </p>
        @if (need) {
          <div class="text-[11px] font-mono bg-anjaninex-navy-soft text-anjaninex-navy
