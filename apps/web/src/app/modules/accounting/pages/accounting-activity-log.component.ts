...
@Component({
  ...
  <div class="p-6 max-w-7xl mx-auto">
    <!-- Sub-nav (same as other accounting pages) -->
    <div class="flex gap-1 mb-6 border-b border-[#ddc8f5] flex-wrap">
      ...
      <a routerLink="/accounting/activity-log" routerLinkActive="!border-[#5c1a8b] !text-[#5c1a8b]" class="px-4 py-2 text-sm font-semibold text-gray-500 border-b-2 border-transparent hover:text-[#5c1a8b]">🕵️ Log</a>
    </div>

    <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
      <div>
        <h2 class="font-display font-black text-2xl text-[#5c1a8b]">🕵️ Accounts Activity Log</h2>
    ...
    <div class="grid grid-cols-3 gap-3 mb-4">
      ...
      <div class="card text-center"><div class="text-2xl font-black text-blue-600">{{ count('update') }}</div><div class="text-xs uppercase font-bold text-gray-500">✏️ Edits</div></div>
      <div class="card text-center"><div class="text-2xl font-black text-red-600">{{ count('delete') }}</div><div class="text-xs uppercase font-bold text-gray-500">🗑️ Deletes</div></div>
    </div>
              ...
              <tr class="border-t hover:bg-[#faf5ff] align-top">
                ...
                <td class="px-3 py-2 text-center">
                  <span class="px-2 py-0.5 rounded-full text-xs font-bold"
                    ...
                    {{ r.action==='insert' ? '➕ Entry' : r.action==='delete' ? '🗑️ Delete' : '✏️ Edit' }}
                  </span>
                </td>
