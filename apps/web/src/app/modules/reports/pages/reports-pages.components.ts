...
const subNav = `
  <div class="flex gap-1 mb-6 border-b border-[#ddc8f5] flex-wrap">
    ...
    <a routerLink="/reports/incentive" routerLinkActive="!border-[#5c1a8b] !text-[#5c1a8b]"
       class="px-4 py-2 text-sm font-semibold text-gray-500 border-b-2 border-transparent hover:text-[#5c1a8b]">🎁 Incentive</a>
    <a routerLink="/reports/party-ledger" routerLinkActive="!border-[#5c1a8b] !text-[#5c1a8b]"
       class="px-4 py-2 text-sm font-semibold text-gray-500 border-b-2 border-transparent hover:text-[#5c1a8b]">📒 Party Ledger</a>
