...
<!-- COMMISSION fields hata diye — user request (06/06/26) -->
  ...
  styles: [`
    ...
    .bp-table { width: 100%; font-size: 17px; border-collapse: collapse; }
    .bp-table input { font-size: 17px; }
    .bp-table thead { background: #f0e6ff; color: #5c1a8b; }
    .bp-table th { padding: 8px; text-align: left; font-size: 13px; font-weight: 800; text-transform: uppercase; }
